...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-auto mr-auto">
                    <h5 class="m-0 font-weight-bold text-primary">Form Pengajuan Surat Berkelakuan Baik</h5>
                </div>
                <div class="col-auto">
        ...
        <div class="card-body">
            <form action="/permohonan/save/6" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
