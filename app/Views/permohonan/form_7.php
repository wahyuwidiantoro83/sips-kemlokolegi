...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-auto mr-auto">
                    <h5 class="m-0 font-weight-bold text-primary">Form Pengajuan Surat Keterangan Domisili</h5>
                </div>
                <div class="col-auto">
        ...
        <div class="card-body">
            <form action="/permohonan/save/7" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?php echo (isset($validation['domisili'])) ? 'is-invalid' : ''; ?>" id="koldomisili" name="domisili" placeholder="Alamat Domisili/Saat ini">
                        <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            <?php if (isset($validation['domisili'])) {
                                echo $validation['domisili'];
                            } ?>
                        </div>
                    </div>
                </div>
