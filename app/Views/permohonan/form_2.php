...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-auto mr-auto">
                    <h5 class="m-0 font-weight-bold text-primary">Form Pengajuan Surat Keterangan Penghasilan</h5>
                </div>
                <div class="col-auto">
        ...
        <div class="card-body">
            <form action="/permohonan/save/2" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control <?php echo (isset($validation['penghasilan'])) ? 'is-invalid' : ''; ?>" id="kolpenghasilan" name="penghasilan" placeholder="1.234.567" required>
                        </div>
                        <div id="validationServerUsernameFeedback" class="invalid-feedback">
                        ...
                        <small id="descpenghasilan" class="form-text text-muted">
                            Tulis besaran penghasilan pemohon saat ini dengan benar dan bertanggung jawab.
                        </small>
                    </div>
                </div>
                <div class="form-group row">
